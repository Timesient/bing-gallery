...
function getCountryCodeByID(id) {
  try {
    ...
    console.log(`Error occured when processing ${id} in function getCountryCodeByID: ${error}`);
  }  
}
...
exports.resolutionConfig = resolutionConfig;
exports.countryConfig = countryConfig;
exports.getCountryCodeByID = getCountryCodeByID;
